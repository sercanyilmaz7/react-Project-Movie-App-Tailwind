...
module.exports = {
  ...
  //? dark modu eklemek için önce theme seviyesinde  darkMode: "class", ekliyoruz, sonra ana HTML ye gidip <html  class="dark" lang="en"> bunu ekliyoruz.
  //? Döküman ise => https://tailwindcss.com/docs/dark-mode
};
